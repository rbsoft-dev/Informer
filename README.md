...
```
cd existing_repo
git remote add origin https://git.rbsoft.ru/ershov/informer.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.rbsoft.ru/ershov/informer/-/settings/integrations)
...
>>>>>>> 4075a8dca1497795924a76ec279603a530961399
